...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto addEvent(Long userId, NewEventDto dto) {
        ...
        LocalDateTime eventDate =
                getEventDateWithValidation(dto.getEventDate());
        ...
        return EventMapper.toFullDto(newEvent, 0L, user);
    }
    ...
    public EventFullDto getPrivateEvent(Long userId, Long eventId) {
        ...
        return EventMapper.toFullDto(event, stat.getHits(), user);
    }
    ...
    public List<EventShortDto> getPublicEvents(EventSearchParams params,
        ...
        Map<Long, UserResponse> usersMap = userClient.getUsers(initiatorIds)
                .stream()
